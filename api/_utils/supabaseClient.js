 ...
 * createClient() itself throws synchronously on a missing/invalid URL, so
 * this is only constructed when configured — otherwise `getClient()` below
 * throws a clear, catchable error at call time instead of crashing the
 * module (and therefore every route file that transitively requires it).
 */
