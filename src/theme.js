...
export const darkTheme = createTheme({
  ...
  components: {
    ...
    MuiPaper: { styleOverrides: { root: { border: `1px solid ${QuantumDark.border}`, backgroundImage: 'none', backgroundColor: QuantumDark.surface } } },
    MuiCard: { styleOverrides: { root: { border: `1px solid ${QuantumDark.border}`, backgroundColor: '#0F0F0F', boxShadow: 'none' } } },
...
export const lightTheme = createTheme({
  ...
  components: {
    ...
    MuiPaper: { styleOverrides: { root: { border: `1px solid ${QuantumLight.border}`, boxShadow: '0 1px 2px rgba(0,0,0,0.08)', backgroundColor: QuantumLight.surface } } },
    MuiCard: { styleOverrides: { root: { border: `1px solid ${QuantumLight.border}`, backgroundColor: QuantumLight.surface, boxShadow: '0 1px 2px rgba(0,0,0,0.06)' } } },
