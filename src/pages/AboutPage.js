...
// Removed: Avatar, Link, Grid, TextField, Alert, CircularProgress, specific icons if only used in sub-components
    ...
    <Box sx={{ p: { xs: 2, sm: 3 }, maxWidth: '900px', margin: 'auto' }}>
      <Paper elevation={3} sx={{ p: { xs: 2, sm: 3, md: 4 }, borderTop: `5px solid ${ABOUT_US_ACCENT_COLOR}` }}>
        ...
        <CreatorProfile
          ...
          accentColor={ABOUT_US_ACCENT_COLOR}
          onOpenContactDialog={handleOpenContactDialog} // Pass handler
        />
        ...
        <ContactFormSection
            recipientEmail={YOUR_EMAIL} // The email address where contact messages will be sent
            accentColor={ABOUT_US_ACCENT_COLOR}
        />
      </Paper>

      {/* Contact Info Dialog (remains in AboutPage as it's specific to its interactions) */}
