...
interface GenerateDashboardPdfReportParams {
  currentUser: User;
  processedStats: DashboardStats;
  activityChartRef: HTMLDivElement | null;
  rollingAverageChartRef: HTMLDivElement | null;
  difficultyBreakdownChartRef: HTMLDivElement | null;
  topicPerformanceRef: HTMLDivElement | null;
  allSubjects: Subject[];
