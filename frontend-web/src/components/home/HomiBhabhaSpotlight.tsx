// src/components/home/HomiBhabhaSpotlight.tsx
/**
 * Homi Bhabha Spotlight Component
 * 
 * This component displays a spotlight card for the Homi Bhabha exam
 * preparation feature. It highlights the specialized exam preparation
 * functionality with navigation to the Homi Bhabha page.
 */
 ...
 * Homi Bhabha Spotlight Component
 * 
 * Displays a spotlight card for Homi Bhabha exam preparation. Features:
 * - Section heading
 * - Card with icon, title, and description
 * - Navigation button to Homi Bhabha page
 * - Hover animations (scale effect)
 * - Responsive layout (mobile and desktop)
 * - Glass morphism styling
 * 
 * This component is used on the HomePage to highlight the specialized
 * Homi Bhabha exam preparation feature.
 * 
 * @returns {JSX.Element} Homi Bhabha spotlight card with navigation
 */
