// src/components/results/ResultRevealOverlay.tsx
/**
 * Result Reveal Overlay Component
 * 
 * This component displays an animated overlay that appears when
 * quiz results are being revealed. It shows an animated icon
 * with a fill animation effect.
 */
 ...
 * Result Reveal Overlay Component
 * 
 * Displays an animated result reveal overlay with:
 * - Full-screen dark overlay
 * - Animated icon (Assessment icon)
 * - Fill animation effect (2 seconds)
 * - Auto-completion callback
 * - Responsive icon sizing
 * - Centered layout
 * 
 * This component is used on quiz result pages to display
 * an animated reveal effect before showing results.
 * 
 * @param {Object} props - Component props
 * @param {Function} props.onAnimationComplete - Callback when animation completes
 * @returns {JSX.Element} Result reveal overlay with animation
 */
