 ...
 * 
 * This component displays a detailed breakdown of quiz questions.
 * It shows each question with its options, user answer, correct answer,
 * and explanation.
 */
 ...
 * Question Breakdown Component
 * 
 * Displays a detailed breakdown of quiz questions with:
 * - Question text (with markdown support)
 * - All options displayed
 * - Visual indicators for:
 *   - Correct answer (green highlight)
 *   - User selected answer (radio button)
 *   - Incorrect answer (red highlight)
 *   - Not answered status
 * - Status chips (Correct, Incorrect, Not Answered)
 * - Explanations (when available)
 * - Color-coded borders (success/error/neutral)
 * 
 * This component is used in CurrentResultView and
 * HistoricalResultDetailView to show detailed question analysis.
 * 
 * @param {Object} props - Component props
 * @param {Array} props.detailedQuestions - Array of question objects with answer data
 * @returns {JSX.Element} Question breakdown with all questions
 */
function QuestionBreakdown({ detailedQuestions }) {
