 ...
 * 
 * Safely stringifies an object to JSON with pretty printing.
 * Returns empty array string if stringification fails.
 * 
 ...
 * Question Detail View Component
 * 
 * Displays a detailed view for managing questions within a topic with:
 * - Questions table display with pagination
 * - Topic information header
 * - Edit mode toggle
 * - Inline editing for all question fields
 * - JSON options editing
 ...
 * - JSON validation
 * 
 * This component is used in ManageQuestions when a topic is selected
 * to manage questions for that specific topic.
 * 
 * @param {Object} props - Component props
 * @param {Object} props.topic - Topic object with id and name
 * @param {Function} props.onBack - Callback to navigate back to topic list
 * @returns {JSX.Element} Question detail management interface
 */
