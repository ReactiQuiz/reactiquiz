// src/components/animations/SpaceBackground.tsx
/**
 * Space Background Component
 * 
 * This component displays an animated space-themed background with
 * stars, atmospheric effects, and horizon glow. It uses Canvas API
 * for star animations and CSS gradients for atmospheric effects.
 */
import React, { useRef, useEffect } from 'react';
import { motion } from 'framer-motion';

/**
 * SpaceBackgroundProps Interface
 * 
 * Props for the SpaceBackground component.
 */
 ...
 * Space Background Component
 * 
 * Displays an animated space-themed background with:
 * - Animated starfield (Canvas-based, 200 stars)
 * - Atmospheric glow effects (Earth's atmosphere simulation)
 * - Horizon glow (curved gradient effects)
 * - Space nebula effects (subtle color gradients)
 * - Responsive canvas sizing
 * - Framer Motion fade-in animation for content
 * 
 * This component is used for hero sections and landing pages
 * to create an immersive space-themed background.
 * 
 * @param {SpaceBackgroundProps} props - Component props
 * @returns {JSX.Element} Space-themed animated background
 */
const SpaceBackground: React.FC<SpaceBackgroundProps> = ({ className, children }) => {
  // Canvas ref for star animation
