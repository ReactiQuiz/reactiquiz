// src/components/animations/ShaderAnimation.tsx
/**
 * Shader Animation Component
 * 
 * This component displays a WebGL shader-based animated background
 * using Three.js. It creates flowing diagonal stripes with animated
 * colors and patterns.
 */
...
/**
 * ShaderAnimationProps Interface
 * 
 * Props for the ShaderAnimation component.
 */
 ...
 * Shader Animation Component
 * 
 * Displays a WebGL shader-based animated background with:
 * - Three.js WebGL renderer
 * - Custom fragment shader with diagonal stripes
 * - Animated color transitions (orange, yellow, blue, purple)
 * - Flowing wave patterns
 * - Brightness and shimmer effects
 * - Responsive canvas sizing
 * - Performance optimizations (pixel ratio limiting)
 * 
 * This component is used for animated backgrounds with
 * complex shader-based visual effects.
 * 
 * @param {ShaderAnimationProps} props - Component props
 * @returns {JSX.Element} WebGL shader animation background
 */
