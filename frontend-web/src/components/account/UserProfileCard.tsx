// src/components/account/UserProfileCard.tsx
/**
 * User Profile Card Component
 * 
 * This component displays a user profile card on the Account page.
 * It includes the user's avatar, name, class, contact information,
 * and action buttons (Edit Profile, Logout).
 */
import React from 'react';
import {
  Paper, Avatar, Typography, Divider, Button, useTheme, Stack, ListItem, ListItemIcon, ListItemText
} from '@mui/material';
...
/**
 * Format User Class Display
 * 
 * Formats the user class with proper ordinal suffix.
 * 
 * @param {string|number} userClass - User class value
 * @returns {string} Formatted class string with ordinal suffix
 */
const formatUserClassDisplay = (userClass) => {
  ...
  // Get last digit for ordinal suffix
 ...
 * - Centered alignment
 * 
 * This component is used on the AccountPage to display user
 * profile information and actions.
 * 
 * @param {Object} props - Component props
 * @param {Object} props.currentUser - Current user object
 * @param {Function} props.onEditDetailsClick - Callback for edit details button
 * @param {Function} props.onLogoutClick - Callback for logout button
 * @param {string} props.accentColor - Accent color for avatar
 * @returns {JSX.Element} User profile card with information and actions
 */
