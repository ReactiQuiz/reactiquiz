 ...
 * 
 * This component renders a registration form with animated shader background
 * and glass morphism styling. It includes multiple input fields for user
 * registration, form validation, and loading states.
 */
 ...
 * Class Options
 * 
 * Available class/grade options for registration.
 * Users can select from classes 6 through 12.
 */
 ...
 * - Multiple input fields (username, email, password, confirm password, address, phone, class)
 ...
 * @returns {JSX.Element} Registration form with animated background
 */
const RegisterForm: React.FC<RegisterFormProps> = ({ onSubmit, isSubmitting, error }) => {
   ...
   * and calls the onSubmit callback with all form data.
   * 
   * @param {FormEvent<HTMLFormElement>} event - Form submission event
   */
  const handleSubmit = (event: FormEvent<HTMLFormElement>): void => {
    event.preventDefault();
    // Call onSubmit callback with all form data
    // Note: Both userClass and class are passed for compatibility
