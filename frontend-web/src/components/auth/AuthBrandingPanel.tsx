...
/**
 * Auth Branding Panel Component
 * 
 * This component displays a branding panel for authentication pages.
 * It shows the app logo, branding text, and decorative elements with
 * animated shader background. Different content is shown for login vs register.
 */
...
/**
 * AuthBrandingPanelProps Interface
 * 
 * Props for the AuthBrandingPanel component.
 */
interface AuthBrandingPanelProps {
  variant?: 'login' | 'register'; // Variant to determine content (default: 'login')
}

/**
 * Auth Branding Panel Component
 * 
 * Displays a branding panel for authentication pages. Features:
 * - Animated shader background
 * - App logo with gradient styling
 * - Brand title with gradient text
 * - Variant-specific subtitle and description
 * - Animated decorative elements
 * - Framer Motion animations for smooth entrance
 * 
 * This component is used on login and registration pages to provide
 * visual branding and context to users.
 * 
 * @param {AuthBrandingPanelProps} props - Component props
 * @returns {JSX.Element} Branding panel with logo, text, and animations
 */
function AuthBrandingPanel({ variant = 'login' }: AuthBrandingPanelProps) {
  // Determine if this is the login variant
