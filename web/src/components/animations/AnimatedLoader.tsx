 ...
 * 
 * This component displays an animated loading spinner with
 * multiple visual elements including rotating rings, pulsing dots,
 * and floating particles. Optimized for mobile performance.
 */
 ...
 * Animated Loader Component
 * 
 * Displays an animated loading spinner with:
 * - Rotating outer ring with gradient
 * - Four orbiting inner dots
 * - Pulsing center dot
 ...
 * 
 * @param {AnimatedLoaderProps} props - Component props
 * @returns {JSX.Element} Animated loader spinner
 */
